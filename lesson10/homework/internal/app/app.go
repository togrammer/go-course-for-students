...
func (a RepoApp) FindUser(ctx context.Context, userID int64) (users.User, error) {
	usr, err := a.repoUsers.FindUser(ctx, userID)
	return usr, err
}

var ErrWrongAdId = errors.New("wrong adId")
var ErrWrongUserId = errors.New("wrong userId")
